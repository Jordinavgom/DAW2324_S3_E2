...
<div class="container">>
<form class id="formulario" action="../controllers/Controlador.php?action=update" method="post" style="margin-top: 20px;">   
    <div class="row">
    <div class="col-md-4">
    ...
    <button id="boto-update" type="button" class="btn btn-primary" name="boto-update" style="margin-top:20px;" onclick="formulari()">Procedeix al pagament</button>
</form>
</div
